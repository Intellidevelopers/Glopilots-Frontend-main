...
const [selectedOption3, setSelectedOption3] = useState(""); // Store the selected option for the third group
  ...
  const options = [
    { label: "Be my own boss", value: "boss" },
    { label: "Make Extra money on the side", value: "money" },
    { label: "Save for a specific purchase", value: "purchase" },
    { label: "Meet new people", value: "people" },
    { label: "Need something temporary", value: "temporary" },
  ];
      const options2 = [
    { label: "Fewer than 5 hours", value: "fewer5" },
    { label: "5 - 15 hours", value: "5to15" },
    { label: "6 - 20 hours", value: "6to20" },
    { label: "21 - 35 hours", value: "21to35" },
    { label: "36+ hours", value: "36plus" },
  ];
  ...
  const options3 = [
    ...
    const options4 = [
    { label: "No just Glopilot", value: "morning" },
    { label: "Afternoon", value: "afternoon" },
    { label: "Evening", value: "evening" },
    { label: "Night", value: "night" },
    { label: "Weekend", value: "weekend" },
              ...
              return (
               <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    <View style={[styles.radioInput, isActive && styles.outerborder]}>
                    <View style={[styles.inner, isActive && styles.radioInputActive]}></View>
                    </View>
      ...
      {options3.map((option) => (
        ...
        >
          <View
            style={[
              styles.checkboxIcon,
              selectedValues.includes(option.value) && styles.selectedCheckboxIcon,
            ]}
          >
            {selectedValues.includes(option.value) && (
