...
const Activity = ({ navigation }) => {
  ...
  const showLessItems = (allData, stateDate, setter) => {
    const currentLength = stateDate.length;
    const newLength = Math.floor(currentLength / 2) + (currentLength % 2);
  ...
  return (
    <SafeAreaView style={{ flex: 1, marginVertical: 20 }}>
      <View style={styles.container}>
        <Header navigation={navigation} title={'Activity'} />
          ...
          <View style={{ paddingHorizontal: 15 }}>
            <View style={{ marginBottom: 15 }}>
              ...
              <View
                ...
                <Text style={{ color: '#545454', fontSize: 12 }}>Dec 12</Text>
                <MaterialIcons
                  ...
                  color="#0D1317"
                />
                <Text style={{ color: '#545454', fontSize: 12 }}>05:36 PM</Text>
              </View>
              <Text style={{ color: '#0D1317', fontSize: 12 }}>$14.98</Text>
            </View>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ padding: 10 }}>
               ...
               (
                  <Text
                    onPress={() => showLessItems(RIDE_DATA, rideData, setRideData)}
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ padding: 10 }}>
                ...
                : (
                  <Text
                    onPress={() => showLessItems(WHEELS, wheels, setWheels)}
                    style={{ color: 'red', alignSelf: 'flex-end' }}>
                    View less
                  </Text>
                )
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ padding: 10 }}>
                ...
                : (
                  <Text
                    onPress={() => showLessItems(FOODY, foody, setFoody)}
                    style={{ color: 'red', alignSelf: 'flex-end' }}>
                    View less
                  </Text>
                )
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ padding: 10 }}>
                ...
                : (
                  <Text
                    onPress={() => showLessItems(PACKAGES, packages, setPackages)}
                    style={{ color: 'red', alignSelf: 'flex-end' }}>
                    View less
                  </Text>
                )
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={{ padding: 10 }}>
                ...
                : (
                  <Text
                    onPress={() => showLessItems(TRAVELS, travels, setTravels)}
                    style={{ color: 'red', alignSelf: 'flex-end' }}>
                    View less
                  </Text>
                )
