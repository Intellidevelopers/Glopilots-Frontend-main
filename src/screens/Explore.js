  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <RectangleCard title="Rent Cars" imageSource={require('../../assets/home/drive.png')} targetScreen="Home"/>
      </View>
      <View style={styles.row}>
        <RectangleCard title="Packages/Deliveries" imageSource={require('../../assets/home/deliveries.png')} targetScreen="PackageDelivery"/>
        <RectangleCard title="Carpool-Shared Ride" imageSource={require('../../assets/home/people.png')}/>
      ...
      <View style={styles.row}>
        ...
        <RectangleCard title="Rent by hours" imageSource={require('../../assets/home/ride-time.png')}/>
        <RectangleCard title="Charter" imageSource={require('../../assets/home/truck-t.png')} targetScreen="Charter" />
      </View>
      <View style={styles.row}>
        <RectangleCard title="Scooter" imageSource={require('../../assets/home/scooter.png')} targetScreen="Scooter"/>
      ...
      <View style={styles.row}>
        <RectangleCard title="Food" imageSource={require('../../assets/home/food.png')} />
      ...
      <View style={styles.row}>
        <RectangleCard title="Pharmacy" imageSource={require('../../assets/home/pharmacy.png')}/>
        <RectangleCard title="Babys" imageSource={require('../../assets/home/baby.png')}/>
...
<View style={styles.row}>
        ...
        <RectangleCard title="Shorts Stay" imageSource={require('../../assets/home/short-stay.png')} targetScreen="ShortStay"/>
...
const RectangleCard = ({ title, imageSource, targetScreen }) => {
    ...
    const handlePress = () => {
      ...
      else if (title === 'Book Boat Cruise') {
        // Navigate to the Flight booking component and pass data as needed
