      ...
      if (
        ...
        if (countryComponent) {
          ...
          const autocompleteResponse = await fetch(
            `https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${text}&components=country:${countryCode}&types=(regions)&key=AIzaSyAMK0gm6FqImxY1oLDQ72UcTuZzybFl7Lw`
          );
