...
import DropdownChild from "../../../Travel/components/DropdownChild";
const data = [
  { label: '1', value: '1' },
  { label: '2', value: '2' },
  { label: '3', value: '3' },
        ...
        <SafeAreaView style={{ marginBottom: 30 }}>
          ...
          <View style={{ width: '90%', alignSelf: 'center' }}>
            <View style={{ marginTop: 30 }}>
              <Image style={{ width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} source={require("../Travel/images/pexels-asad-photo-maldives-1.png")} />
          ...
          <View style={{ width: '90%', alignSelf: 'center' }}>
            <View style={{ marginTop: 30 }}>
              <Image style={{ width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} source={require("../Travel/images/pexels-chris-duan-2.png")} />
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
          ...
          <View style={{ width: '90%', alignSelf: 'center' }}>
            <View style={{ marginTop: 30 }}>
              <Image style={{ width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} source={require("../Travel/images/pexels-matt-hardy-2602543.png")} />
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
          ...
          <View style={{ width: '90%', alignSelf: 'center' }}>
            <View style={{ marginTop: 30 }}>
              <Image style={{ width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} source={require("../Travel/images/nick-perez-b-1.png")} />
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
          ...
          <View style={{ width: '90%', alignSelf: 'center' }}>
            <View style={{ marginTop: 30, marginBottom: 30 }}>
              <Image style={{ width: '100%', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} source={require("../Travel/images/hannah-tu-1.png")} />
              <View style={{ flexDirection: 'row', marginTop: 20 }}>
