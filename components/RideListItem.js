...
const RideListItem = ({ item, navigation }) => {
      ...
      <View
        ...
        <View style={{ left: 10 }}>
          ...
          <View
            ...
            <Text style={{ color: '#545454', fontSize: 12 }}>{formattedDate}</Text>
            <MaterialIcons
              ...
              color="#0D1317"
            />
            <Text style={{ color: '#545454', fontSize: 12 }}>{item.tripTime}</Text>
          </View>
          <Text style={{ color: '#0D1317', fontSize: 12 }}>${item.tripAmount}</Text>
        </View>
      </View>
